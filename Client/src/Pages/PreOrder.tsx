...
<button className="w-full mx-auto block relative h-11  overflow-hidden rounded bg-yellow-500 px-5 py-1 my-2 text-white transition-all duration-300 hover:bg-yellow-700">Confirm</button>
    </div>
  );
}
