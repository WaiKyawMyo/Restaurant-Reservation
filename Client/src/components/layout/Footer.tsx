...
function Footer() {
  return (
      <footer className="w-full py-14 bg-[#36454f] ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                <Link to={'/'}  className="flex justify-center ">
                    <img src={Logo} className='w-26 bg-white rounded-md' alt="" />
                </Link>
                    ...
                    <span className="text-lg text-gray-300 text-center block">©<a href="https://pagedone.io/">mumurestaurant</a> 2025, All rights reserved.</span>
            </div>
        </div>
    </footer>
